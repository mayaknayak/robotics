...
void ImageConverter::imageCb(const sensor_msgs::ImageConstPtr& msg){
        ...
        double u = 0.0029512*(i_centroid - 320);
	double v = 0.0029512*(j_centroid - 240);
        block_pose_.pose.position.x = (0.9787340*u - 0.205133*v + .545); //not true, but legal
        block_pose_.pose.position.y = -1*(0.205133*u + 0.9787340*v - .317); //not true, but legal
        double theta=.2066;
